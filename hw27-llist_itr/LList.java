...
{ 
	...
	public void remove() 
	{
	    ...
	    DLLNode<T> temp = _dummy.getPrev();
	    //if the first element is the last returned element...
	    if (temp.getCargo().equals(getFirst())) {
		removeFirst();
	    }
	    //if the last element is the last returned element...
	    else if (temp.getCargo().equals(getLast())) {
		removeLast();
	    }
