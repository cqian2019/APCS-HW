...
// Team Holy Cross -- Hasif Ahmed, Cheryl Qian
// APCS1 p2
...
public class Rational implements Comparable
{
   ...
   *********************/
	...
	Comparable inst = (Comparable)other;
	Rational newInst = (Rational)inst;
	newInst.reduce();
	reduce();
	boolean ans = _numerator == newInst._numerator && _denominator == newInst._denominator;
        return ans;
  ...
  public int compareTo( Object other )
  {
	  ...
	  Comparable inst = (Comparable)other;
	  Rational newInst = (Rational)inst;
	  this.subtract(newInst);
      }
      else {
	  throw new RuntimeException("Invalid argument: not a Rational");
      }
